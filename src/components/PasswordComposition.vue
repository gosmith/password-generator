<template>
  <div class="uk-card uk-card-default uk-margin uk-margin-medium-top uk-margin-medium-bottom">
    ...
    <div class="uk-margin-remove">
      <div class="uk-inline">
		...
		<div class="setting ">
			...
			<input class="uk-input uk-width-1-4@m" v-model="passwordLength"
      type="number" id="length" min='4' max='20' />
    </div>
      <div class="uk-margin">
        <div class="uk-form-controls">
          <div class="uk-flex uk-flex-column">
            <div class="setting uk-margin-remove">
              ...
              <input class="checkbox" v-model="includeUpperCase" type="checkbox">
            </div>
            <div class="setting uk-margin-remove">
    ...
    <button class="uk-button uk-button-default uk-align-right" 
